...
pub enum PrivateStreamMsg {
    ...
    JsonRpcError(JsonRpcError),
    BullishWebSocketResponse(BullishWebSocketResponse),
    PrivateErrorResponse(PrivateErrorResponse),
}
...
// text={"error":{"code":"-32700","errorCodeName":"JSON_PARSE_ERROR","message":"Failed to parse JSON text","errorCode":"29016"},"id":null,"jsonrpc":"2.0"}
...
pub struct JsonRpcError {
    ...
    id: Option<String>,
    error: serde_json::Value, // placeholder to parse later
}
...
// BullishWebSocketResponse { trading_account_id: None, event_type: "response", event_topic: "V1TAResponse", data: Object {"message": String("Successfully authenticated"), "responseCode": String("200"), "responseCodeName": String("OK")} }
...
pub struct BullishWebSocketResponse {
    ...
    // private data stream events only
    pub trading_account_id: Option<String>,
    #[serde(rename = "type", default)]
    // "update" OR "snapshot"
    pub event_type: String,
    // the topic/sub like "V1TALevel2", "V1TALevel1", ...
    #[serde(rename = "dataType", default)]
    pub event_topic: String, 
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>, 
    // placeholder to parse later
    // todo figure out enum parsing
...
// BullishWebSocketResponse { trading_account_id: None, event_type: "response", event_topic: "V1TAResponse", 
// data: Object {"message": String("Successfully authenticated"), "responseCode": String("200"), "responseCodeName": String("OK")} }
// V1TAResponse (Private Data)
#[derive(Debug, Deserialize)]
pub struct PrivateResponse {
    pub message: String,
    #[serde(rename = "responseCode", default, skip_serializing_if = "Option::is_none")]
    pub response_code: Option<String>,
    #[serde(rename = "responseCodeName", default, skip_serializing_if = "Option::is_none")]
...
// V1TAErrorResponse
//{"error":{"code":"-32700","errorCodeName":"JSON_PARSE_ERROR","message":"Failed to parse JSON text","errorCode":"29016"},"id":null,"jsonrpc":"2.0"}

//error=text={"error":{"code":"-32700","errorCodeName":"JSON_PARSE_ERROR","message":"Failed to parse JSON text","errorCode":"29016"},"id":null,"jsonrpc":"2.0"}
